...
void ChessQueenStone::setValidMovesList() {
...
void ChessQueenStone::setValidListHelper(Side sideRow, Side sideCol) {
	try {
...
char ChessQueenStone::getCharByType() {
	char returnVal;
	_playerNumber == 1 ? returnVal = 'q' : returnVal = 'Q';
	return returnVal;
}
